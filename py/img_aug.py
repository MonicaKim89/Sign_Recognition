            ...
            [
                ...
                iaa.SomeOf((0, 5), 
                    [ 
                        ...
                        iaa.Emboss(alpha=(0, 1.0), strength=(0, 2.0)), # emboss images # search either for all edges or for directed edges, 
                        ...
                        iaa.AddToHueAndSaturation((-20, 20)), # change hue and saturation # either change the brightness of the whole image (self.sometimes # per channel) or change the brightness of subareas 
                        iaa.OneOf([ 
